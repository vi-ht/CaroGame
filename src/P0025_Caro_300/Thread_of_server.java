 ...
 * @author Thanh Vi
 */
public class Thread_of_server extends Thread{
       Socket socket;
      ...
      public Thread_of_server(Socket socket, String sender, String receiver, Vector<Socket> listSocket, Vector<String> Name) {
            this.socket = socket;
            this.sender = sender;
